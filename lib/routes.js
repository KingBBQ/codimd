...
const wikiPageController = require('./homepage/wiki')
...
const wikiController = require('./wiki/index')
...
// wiki page
appRouter.get('/wiki', wrap(wikiPageController.showIndex))
appRouter.get('/wikiJS', wrap(wikiPageController.showJS))
...
appRouter.get('/wikiPages', wikiController.pagesGet)
